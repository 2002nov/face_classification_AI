...
# Load a model
model = YOLO("runs/classify/train15#/weights/best.pt") # load a pretrained model (recommended for training)
...
files = [f for f in pathlib.Path().glob("Face/train/Errrr/*.png")]
