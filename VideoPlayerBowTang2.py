...
#------------------------------------------------------------------------------------------------------------
    def __init__(self):
        ...
        file_list_column = [
            [sg.Text("Classes")],
            [sg.Image("/home/rvp/Work_Student2024/Bow/picture/117.png"), sg.Text("0 Angry   "),sg.Image(r"/home/rvp/Work_Student2024/video/class/Image/10.png"), sg.Text("10 Scared")],
